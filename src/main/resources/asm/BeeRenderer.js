    ...
    return {
    	'BeeRenderer': {
    		...
    		'transformer': function(classNode) {
    			var count = 0
    			var found = false
    			var fn = asmapi.mapMethod('func_77037_a') // getDeathMaxRotation
    			...
    			count++
    			if (!found) {
    				insert_func_77037_a(classNode, fn)
    				insert_func_77037_a_syn(classNode, fn)
    			}
    			else
...
function insert_func_77037_a(cobj, fn) {
	var desc = "(Lnet/minecraft/entity/passive/BeeEntity;)F"
...
function insert_func_77037_a_syn(cobj, fn) {
	var desc = "(Lnet/minecraft/entity/LivingEntity;)F"
	var obj = new MethodNode(opc.ACC_SYNTHETIC | opc.ACC_BRIDGE | opc.ACC_PROTECTED, fn, desc, null, null)
	cobj.methods.add(obj)
	var desc2 = "(Lnet/minecraft/entity/passive/BeeEntity;)F"
	var op1 = new VarInsnNode(opc.ALOAD, 0)
	var op2 = new VarInsnNode(opc.ALOAD, 1)
	var op3 = new TypeInsnNode(opc.CHECKCAST, "net/minecraft/entity/passive/BeeEntity")
